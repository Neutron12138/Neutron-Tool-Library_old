...
namespace ntl
{
    ...
    CountdownTimer::SelfType &CountdownTimer::set_duration(const Time &duration)
    {
        reset();
        m_duration = duration;
        return *this;
    ...
    CountdownTimer::SelfType &CountdownTimer::start(CountdownType countdown_type)
    {
        m_is_started = true;
    ...
    CountdownTimer::SelfType &CountdownTimer::stop()
    {
        m_is_started = false;
        onStoped();
        return *this;
    ...
    CountdownTimer::SelfType &CountdownTimer::restart()
    {
        start();
        onRestarted();
        return *this;
    ...
    CountdownTimer::SelfType &CountdownTimer::reset()
    {
