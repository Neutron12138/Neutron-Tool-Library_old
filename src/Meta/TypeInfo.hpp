...
namespace ntl
{
    ...
    class TypeInfo : virtual public FundamentalTypeInfo<m_Type>, virtual public CompoundTypeInfo<m_Type>, virtual public TypeAttributeInfo<m_Type>, virtual public SupportedOperations<m_Type>, virtual public AttributeQueryInfo<m_Type>
    {
    public:
        using Type = m_Type;
