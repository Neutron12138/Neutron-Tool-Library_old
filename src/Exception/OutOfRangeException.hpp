...
namespace ntl
{
    ...
    public:
        ...
        NTL_EXPLICIT OutOfRangeException(const String &why, const String &where);
        NTL_EXPLICIT OutOfRangeException(const OutOfRangeException &from) = default;
        ~OutOfRangeException() NTL_OVERRIDE = default;
