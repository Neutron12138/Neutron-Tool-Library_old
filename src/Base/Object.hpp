...
namespace ntl
{
    ...
    public:
        NTL_INLINE NTL_CONSTEXPR Object() NTL_NOEXCEPT = default;
        NTL_INLINE NTL_CONSTEXPR Object(const SelfType &from) NTL_NOEXCEPT = default;
        NTL_INLINE ~Object() NTL_NOEXCEPT = default;
