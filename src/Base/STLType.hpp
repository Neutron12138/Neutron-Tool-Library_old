...
namespace ntl
{
    ...
    class NTL_ALIGN STLType : public BasicObject
    {
    public:
        /// @brief 字符类型
    ...
    public:
        NTL_INLINE NTL_CONSTEXPR STLType() NTL_NOEXCEPT = default;
        NTL_INLINE NTL_CONSTEXPR STLType(const SelfType &from) NTL_NOEXCEPT = default;
        NTL_INLINE ~STLType() NTL_NOEXCEPT = default;
