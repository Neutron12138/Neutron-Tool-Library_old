...
namespace ntl
{
    ...
    public:
        NTL_INLINE NTL_CONSTEXPR ResourceDeleter() NTL_NOEXCEPT = default;
        NTL_INLINE NTL_CONSTEXPR ResourceDeleter(const SelfType &from) NTL_NOEXCEPT = default;
        NTL_INLINE ~ResourceDeleter() = default;
